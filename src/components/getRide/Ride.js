                    ...
                    <div>
                        <div className="ride-page-top">
                            <div className="ride-header">
                                ...
                                <h3>
                                    Book your ride here. <br /> You have the chance to drive yourself <br />{' '}
                                    to your dream destination and we <br /> are here to help you.
                                </h3>
                            </div>
                        ...
                        <div>
                            ...
                            {filteredCars.map((car, index) => (
                                <Tile key={index} value={car.id} car={car} bookingDetails={bookingDetails} />
                            ))}
                        </div>
                    </div>
                )}
