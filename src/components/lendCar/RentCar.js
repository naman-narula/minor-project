                ...
                <section className="rent-car-container">
                    <div className="rent-image">
                        <div className="rent-header">
                            ...
                            <h3>
                                Cars in good condition can be found at reasonable prices. Lorem ipsum dolor
                                sit amet consectetur adipisicing elit. Autem, ullam!
                            </h3>
                        </div>
                    </div>
                        ...
                        <div className="features">
                            <div className="feature">
                                ...
                                <p>
                                    ...
                                    delectus laboriosam cumque vel tempora at et facilis quidem temporibus
                                    est?
                                </p>
                            </div>
                            <div className="feature">
                                ...
                                <p>
                                    ...
                                    veritatis voluptatum alias non ipsam beatae, nobis inventore adipisci
                                    illum?
                                </p>
                            </div>
                            <div className="feature">
                                ...
                                <p>
                                    ...
                                    nobis doloribus iure reprehenderit reiciendis possimus! Vel, cum
                                    doloremque.
                                </p>
                            </div>
                            <div className="feature">
                                ...
                                <p>
                                    ...
                                    excepturi amet vel cumque cum facilis dolorum voluptatem sint quos.
                                </p>
                            </div>
                        </div>
                    </div>
