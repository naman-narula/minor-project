...
function CarTile(props) {
  ...
  async function handleClick (){
    ...
    formData.append('price',moment(props.bookingDetails.toDate).diff(moment(props.bookingDetails.fromDate),'days')*props.car.details__price_by_model)
        ...
        <div className='tile-container'>
            ...
            <Grid container >
              ...
              <Grid item sm={12} md={5} className='car-thumbnail'>
                ...
                <Link to={{pathname:'/payment',state:{booking:props.bookingDetails,car:props.car}}}>
                <button
                  className='date-btn'
                >
                    Book your ride
